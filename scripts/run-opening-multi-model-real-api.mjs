...
const environment = {
  ...process.env,
  COPV2_RUN_OPENING_MULTI_MODEL_REAL_API: '1',
  COPV2_REAL_API_SETTINGS_PATH: settingsPath,
  COPV2_OPENING_MULTI_MODEL_TIMEOUT_MS:
    process.env.COPV2_OPENING_MULTI_MODEL_TIMEOUT_MS || '600000',
  COPV2_OPENING_MULTI_MODEL_MAX_ATTEMPTS:
...
const child = spawn(
  ...
  [
    vitestEntry,
    'run',
    'tests/integration/openingMultiModelRealApi.integration.test.ts',
    '--reporter=verbose',
    '--testTimeout=7200000'
  ],
  {
