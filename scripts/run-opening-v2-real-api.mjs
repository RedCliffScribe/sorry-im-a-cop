...
const environment = {
  ...process.env,
  COPV2_RUN_OPENING_V2_REAL_API: '1',
  COPV2_REAL_API_SETTINGS_PATH: settingsPath,
  COPV2_OPENING_V2_PROFILE:
    process.env.COPV2_OPENING_V2_PROFILE || 'api_yuqing',
  COPV2_OPENING_V2_MODEL:
    process.env.COPV2_OPENING_V2_MODEL || 'grok-4.20-fast',
  COPV2_OPENING_V2_RUNS: process.env.COPV2_OPENING_V2_RUNS || '3',
  COPV2_OPENING_V2_TIMEOUT_MS:
    process.env.COPV2_OPENING_V2_TIMEOUT_MS || '600000'
};
...
const child = spawn(
  ...
  [
    vitestEntry,
    'run',
    'tests/integration/openingV2RealApi.integration.test.ts',
    '--reporter=verbose',
    '--testTimeout=3600000'
  ],
  {
