...
const environment = {
  ...process.env,
  COPV2_RUN_TRIAD_GAMEPLAY_REAL_API: '1',
  COPV2_REAL_API_SETTINGS_PATH: settingsPath,
  COPV2_TRIAD_REAL_REQUEST_TIMEOUT_MS: process.env.COPV2_TRIAD_REAL_REQUEST_TIMEOUT_MS || '600000'
};
...
const child = spawn(
  ...
  [
    vitestEntry,
    'run',
    'tests/integration/triadGameplayRealApi.integration.test.ts',
    '--reporter=verbose',
    '--testTimeout=3600000'
  ],
  {
