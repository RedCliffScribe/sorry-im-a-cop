...
export function HomeScreen({ settings, isSettingsLoaded, onStart, onLoad, onSettings }: HomeScreenProps) {
    ...
    <main className="home-screen">
      ...
      <section className="home-panel" aria-label="主菜单">
        <h1 className="home-title-heading">
          ...
          <img className="home-title-mark" src={homeTitleMark} alt="" aria-hidden="true" />
        </h1>
        ...
        <div className="home-actions">
          ...
          <button type="button" data-index="03" aria-label="设置" onClick={() => onSettings('api')}>
            设置
          </button>
          <button
            type="button"
