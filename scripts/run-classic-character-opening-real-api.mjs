...
const environment = {
  ...process.env,
  COPV2_RUN_CLASSIC_CHARACTER_OPENING_REAL_API: '1',
  COPV2_REAL_API_SETTINGS_PATH: settingsPath,
  COPV2_CUSTOM_CONTENT_OPENING_REAL_API_REQUEST_TIMEOUT_MS:
    process.env.COPV2_CUSTOM_CONTENT_OPENING_REAL_API_REQUEST_TIMEOUT_MS ||
    '600000',
  COPV2_CUSTOM_CONTENT_OPENING_REAL_API_MAX_ATTEMPTS:
    process.env.COPV2_CUSTOM_CONTENT_OPENING_REAL_API_MAX_ATTEMPTS || '2',
  COPV2_CLASSIC_CHARACTER_OPENING_REAL_API_SUCCESS_TARGET:
    process.env.COPV2_CLASSIC_CHARACTER_OPENING_REAL_API_SUCCESS_TARGET || '3',
  COPV2_CLASSIC_CHARACTER_OPENING_REAL_API_MAX_ATTEMPTS:
