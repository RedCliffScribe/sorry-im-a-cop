...
const environment = {
  ...process.env,
  COPV2_RUN_PLAYER_VITALS_REAL_API: '1',
  COPV2_REAL_API_SETTINGS_PATH: settingsPath,
  COPV2_PLAYER_VITALS_REQUEST_TIMEOUT_MS:
    process.env.COPV2_PLAYER_VITALS_REQUEST_TIMEOUT_MS || '600000'
};
...
const child = spawn(
  ...
  [
    vitestEntry,
    'run',
    'tests/integration/playerVitalsReviewRealApi.integration.test.ts',
    '--reporter=verbose',
    '--testTimeout=1800000'
  ],
  {
