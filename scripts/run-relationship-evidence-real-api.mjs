...
const environment = {
  ...process.env,
  COPV2_RUN_RELATIONSHIP_EVIDENCE_REAL_API: '1',
  COPV2_REAL_API_SETTINGS_PATH: settingsPath,
  COPV2_RELATIONSHIP_EVIDENCE_PROFILE:
    process.env.COPV2_RELATIONSHIP_EVIDENCE_PROFILE || 'api_tianbohe',
  COPV2_RELATIONSHIP_EVIDENCE_MODEL:
    process.env.COPV2_RELATIONSHIP_EVIDENCE_MODEL || 'gemini-3-flash-preview',
  COPV2_RELATIONSHIP_EVIDENCE_TIMEOUT_MS:
    process.env.COPV2_RELATIONSHIP_EVIDENCE_TIMEOUT_MS || '600000'
};
...
const child = spawn(
  ...
  [
    vitestEntry,
    'run',
    'tests/integration/relationshipEvidenceRealApi.integration.test.ts',
    '--reporter=verbose',
    '--testTimeout=3600000'
  ],
  {
